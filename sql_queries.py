...
songplay_table_insert = ("""INSERT INTO songplays (start_time, userId, level, song_id, artist_id, sessionId, location, userAgent) VALUES (%s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT (songplay_id) DO NOTHING""")
...
# FIND RECORDS FOR BOTH artist_id AND song_id

song_artist_data = ("""SELECT * FROM songplays WHERE song_id IS NOT NULL and artist_id IS NOT NULL;""")
